<template>
  <div v-if="show" class="fullscreen-loading">
    <div class="loader">
      <div class="wrapper">
...
.fullscreen-loading .catContainer {
  width: 100%;
  height: fit-content;
  display: flex;
  align-items: center;
...
.fullscreen-loading .catbody {
  width: 80px;
}
.fullscreen-loading .tail {
  position: absolute;
  width: 17px;
  top: 50%;
...
.fullscreen-loading .zzz {
  color: black;
  font-weight: 700;
  font-size: 15px;
  animation: zzz 2s linear infinite;
}
.fullscreen-loading .bigzzz {
  color: black;
  font-weight: 700;
  font-size: 25px;
  margin-left: 10px;
